...
const ApplicationProcess = () => {
    return (
        <div>
            <div className='lg:mx-10 text-center mx-4 mt-10'>
            <h1 className='text-black lg:text-5xl text-4xl text-center font-bold'>Easy Application Process</h1>
            <p className='lg:px-72 lg:text-3xl text-2xl font-serif lg:mt-5 mt-4 px-8'>Follow these steps to apply. Feel free to reach out if you have any questions or need any support along the way!</p>
            </div>

            {/* Card Design */}
            <div className='mt-14 px-10'>
  <div className="flex flex-col justify-center items-center lg:flex-row lg:mx-32 lg:mt-16 lg:gap-8">
    <div class="flex items-center mb-4 lg:gap-3">
      ...
      <div class="ml-4">
        <h2 class="text-xl lg:text-3xl font-sans text-red-500">Application</h2>
    ...
    <div class="flex items-center mb-4 lg:gap-3">
      ...
      <div class="ml-4">
        <h2 class="text-xl lg:text-3xl font-sans lg:w-11/12 text-red-500">Financial Aid (Optional)</h2>
    ...
    <div class="flex items-center mb-4 lg:gap-3">
      ...
      <div class="ml-4">
        <h2 class="text-xl lg:text-3xl font-sans lg:w-11/12 text-red-500">Family Interview</h2>
    ...
    <div class="flex items-center mb-4 lg:gap-3">
      ...
      <div class="ml-4">
        <h2 class="text-xl lg:text-3xl font-sans text-red-500">Enrollment</h2>
  ...
  <div className="lg:w-10/12 lg:h-0 h-0 border-[1px] border-gray-200 lg:mx-28 lg:mt-36 mb-7 justify-center items-center"></div>
</div>
