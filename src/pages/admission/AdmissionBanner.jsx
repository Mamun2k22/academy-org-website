          ...
          <div className="absolute flex">
            <div className="text-white flex items-center mx-6 lg:mx-24 lg:mt-20 lg:w-6/12">
              <div className=" lg:mt-12 mt-24">
                <h1 className="text-2xl">ADMISSIONS INFO</h1>
                <h2 className="text-4xl font-extrabold py-6">
                  Join the All Start Family
                </h2>
                <p className="w-11/12 text-2xl">
                  Ready to take the next step? Applying to join All Start Academy is easy. Plus, we’re here to guide you through the process, including details on financial aid options. Explore how you can also get involved through volunteering opportunities.
                </p>
