         ...
         <div>
           <div className="absolute top-0 right-1 flex">
            <div className="basis-4/5 pl-20 text-white flex items-center">
              ...
              <button className="bg-deep-orange-700 px-6 py-3 mt-5 rounded-full text-sm">Call for Tour</button>
              </div>
            </div>
           <div className="relative">
           <div className="basis-2/5 mt-12 ">
              <img className="h-[600px] w-[700px] pb-5" src="https://libertylaunchacademy.org/wp-content/uploads/2023/07/LibertyLaunchAcademy_K-12_PrivateSchool-LibertyLake-WA-Littles-Launch-Academy-06-900x604.jpg" alt="" />
            </div>
            <img className="absolute top-48 -left-40 h-96 w-72" src="https://libertylaunchacademy.org/wp-content/uploads/2023/07/LibertyLaunchAcademy_K-12_PrivateSchool-LibertyLake-WA-grades9-12-01-900x604.jpg" alt="" />
           </div>
