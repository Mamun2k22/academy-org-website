  ...
  return (
    <div className='lg:py-36'>
      <div className='lg:mx- text-center mx-4'>
        <h1 className='text-blue-500 lg:text-5xl text-4xl text-center font-bold'>Our Team</h1>
        <p className='lg:px-40 lg:text-3xl text-2xl font-serif lg:mt-5 mt-4'>We handpick those who truly understand our innovative educational model and have a proven history of guiding students to success and leadership</p>
      </div>
